...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/WOTvision/btcutil/txsort)
...
```bash
$ go get -u github.com/WOTvision/btcutil/txsort
```
